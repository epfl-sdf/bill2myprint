# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-05-04 20:00
from __future__ import unicode_literals

import bill2myprint.models
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', bill2myprint.models.StringUUIDField(db_column='ID', primary_key=True, serialize=False)),
                ('classdata', models.BinaryField(db_column='ClassData')),
                ('consumerid', bill2myprint.models.StringUUIDField(db_column='ConsumerID', primary_key=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('defaultgroupid', bill2myprint.models.StringUUIDField(blank=True, db_column='DefaultGroupID', null=True)),
                ...
                ('defaultcostcenter', bill2myprint.models.StringUUIDField(blank=True, db_column='DefaultCostCenter', null=True)),
                ...
                ('momsyncflag', models.NullBooleanField(db_column='MomSyncFlag')),
                ('linkedconsumerid', bill2myprint.models.StringUUIDField(blank=True, db_column='LinkedConsumerID', null=True)),
                ('modified', models.DateTimeField(blank=True, db_column='Modified', null=True)),
                ...
                ('hierarchyposition', bill2myprint.models.StringUUIDField(blank=True, db_column='HierarchyPosition', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(db_column='Service', on_delete=django.db.models.deletion.CASCADE, primary_key=True, to='bill2myprint.ServiceT')),
                ('serviceusage', bill2myprint.models.StringUUIDField(blank=True, db_column='ServiceUsage', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.ForeignKey(db_column='UserID', on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='groupmembershipt_user_set', serialize=False, to='bill2myprint.ServiceconsumerT')),
            ],
            options={
